      ...
      <NavbarContainer>
        ...
        {isOpen && (
          <MobileMenu isOpen={isOpen}>
            ...
            <StyledNavLink to="/properties" onClick={() => setIsOpen(false)}>
              Places to stay
            </StyledNavLink>
            <StyledNavLink to="/contact" onClick={() => setIsOpen(false)}>
              Contact
            </StyledNavLink>
            <StyledNavLink to="/blogs" onClick={() => setIsOpen(false)}>
              Blogs
            </StyledNavLink>
        ...
        <NavItems>
          ...
          <StyledNavLink to="/properties">Places to stay</StyledNavLink>
